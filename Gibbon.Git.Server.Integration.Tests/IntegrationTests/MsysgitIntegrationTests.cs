...
namespace Bonobo.Git.Server.Test.Integration.ClAndWeb
{
    ...
    {
        private static readonly string RepositoryName = "Integration";
        private static readonly string RepositoryUrlTemplate = "http://{0}localhost:20000/{2}{1}";

        private static readonly string WorkingDirectory = Path.GetFullPath(@"..\..\..\Tests\IntegrationTests");
        private static readonly string GitPath = Path.GetFullPath(@"..\..\..\Gits\{0}\bin\git.exe");
        ...
        private static readonly string ServerRepositoryBackupPath = Path.Combine(@"..\..\..\Tests\", RepositoryName, "Backup");
