...
public class PathEncoderTest
{
    ...
    {
        Assert.ThrowsException<FormatException>(() => PathEncoder.Decode("\u0394"));
    }
    ...
    {
        Assert.ThrowsException<FormatException>(() => PathEncoder.Decode("~0"));
    }

    [TestMethod]
    public void MissingBothNibbles()
    {
        Assert.ThrowsException<FormatException>(() => PathEncoder.Decode("~"));
    }

    [TestMethod]
    public void BadNibbleValues()
    {
        Assert.ThrowsException<FormatException>(() => PathEncoder.Decode("~no"));
    }
